...
public class StatsMonthFragment extends Fragment {
    ...
    private void loadMonthStats() {
        ...
        for (int d = 1; d <= monthDays; d++) {
            ...
            String dayStr = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(c.getTime());
            ...
            db.collection("dailyMeals")
                    ...
                    .addOnSuccessListener(querySnapshot -> {
                        ...
                        caloriesEntries.add(new BarEntry(dayIndex - 1, totalCalories[0]));
                        proteinEntries.add(new BarEntry(dayIndex - 1, totalProtein[0]));
                        fatEntries.add(new BarEntry(dayIndex - 1, totalFat[0]));
                        carbEntries.add(new BarEntry(dayIndex - 1, totalCarb[0]));
                        fiberEntries.add(new BarEntry(dayIndex - 1, totalFiber[0]));
